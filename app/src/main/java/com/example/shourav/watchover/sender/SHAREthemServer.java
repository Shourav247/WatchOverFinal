...
class SHAREthemServer extends NanoHTTPD {
    ...
    /**
     * Creates an Error {@link com.example.shourav.watchover.sender.NanoHTTPD.Response} with
     *
     * @param status  error Status like <code>Response.Status.FORBIDDEN</code>
     * @param message error message
     * @return {@link com.example.shourav.watchover.sender.NanoHTTPD.Response}
     */
    ...
    /**
     * Creates a success {@link com.example.shourav.watchover.sender.NanoHTTPD.Response} with Shared Files URLS data in @{@link com.google.gson.JsonArray} format
     *
     * @return {@link com.example.shourav.watchover.sender.NanoHTTPD.Response}
     */
    ...
    private Response createLogoResponse() {
        try {
            Bitmap bitmap = BitmapFactory.decodeResource(WatchOver.getInstance().getResources(), R.drawable.watchover);
