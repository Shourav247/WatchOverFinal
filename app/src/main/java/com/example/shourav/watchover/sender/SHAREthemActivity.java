...
package com.example.shourav.watchover.sender;
...
import com.example.shourav.watchover.utils.DividerItemDecoration;
import com.example.shourav.watchover.utils.HotspotControl;
import com.example.shourav.watchover.utils.RecyclerViewArrayAdapter;
import com.example.shourav.watchover.utils.Utils;
import com.example.shourav.watchover.utils.WifiUtils;
...
import static com.example.shourav.watchover.sender.SHAREthemActivity.ShareUIHandler.LIST_API_CLIENTS;
import static com.example.shourav.watchover.sender.SHAREthemActivity.ShareUIHandler.UPDATE_AP_STATUS;
import static com.example.shourav.watchover.utils.Utils.DEFAULT_PORT_OREO;
import static com.example.shourav.watchover.utils.Utils.getRandomColor;
import static com.example.shourav.watchover.utils.Utils.isOreoOrAbove;
...
public class SHAREthemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sender_sharethem);
        ...
        m_receiverQrImage = (ImageView) findViewById(R.id.p2p_connection_qr);
    ...
    protected void onStop() {
        super.onStop();
        if (m_apControlSwitch != null) {
            m_apControlSwitch.setChecked(false);
            Log.e(TAG, "onStop: stopping");
            changeApControlCheckedStatus(true);
            resetSenderUi(true);
        }
    }
    ...
    private void updateApStatus() {
        ...
        if (hotspotControl.isEnabled()) {
            ...
            //generate qr
            String qrContent = "WIFI:"+((config.allowedProtocols.cardinality() == WifiConfiguration.Protocol.WPA) ? "WPA;":"WEP;")+"S:"+config.SSID+";P:"+config.preSharedKey+";;IP:http://" + ip + ":" + hotspotControl.getShareServerListeningPort()+";";
            MultiFormatWriter multiFormatWriter = new MultiFormatWriter();
            try {
                BitMatrix bitMatrix = multiFormatWriter.encode(qrContent, BarcodeFormat.QR_CODE,240,240);
                BarcodeEncoder barcodeEncoder = new BarcodeEncoder();
                Bitmap bitmap = barcodeEncoder.createBitmap(bitMatrix);
                m_receiverQrImage.setImageBitmap(bitmap);
