...
public class ProvideFileTestCase extends InstrumentationTestCase {

//	private StorageDel mStorage;
//
//	private final static String DIR_NAME = "ProvideFile Test";
...
//
//		DoEncrypt configuration = new DoEncrypt.Builder().setEncryptContent(IVX, SECRET_KEY).build();
...
//		List<File> filesSize = mStorage.getFiles(DIR_NAME, Order.SIZE);
...
//		List<File> filesName = mStorage.getFiles(DIR_NAME, Order.NAME);
...
//		List<File> files = mStorage.getFiles(DIR_NAME, Order.DATE);
